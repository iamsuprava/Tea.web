        ...
        <div className='flex flex-col items-center lg:flex-row lg:items-start pt-32 lg:pt-32'>
          <div className='flex-1 lg:mt-12'>
            ...
            >
              ...
              TEA DAY  <br /> Profitable and Fastest Growing Tea Franchise Chain
            </h1>
            <p
              ...
              data-aos-delay='600'
            >
              TEA DAY is the best Tea Franchise with Investment around 5 Lakhs, trendy and vibrant café interiors, authentic & exotic tea and coffee flavours, milkshakes & snacks. Average Profit Margin of 60% with Customized menu serving lakhs of customers daily across India.
            </p>
            <div
