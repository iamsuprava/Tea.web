    ...
    >
      ...
      <div className='flex items-center'>
        <div className='flex gap-x-4 lg:gap-x-9'>
          ...
          <button className='btn btn-md lg:px-[30px] bg-green-100 border border-orange text-white font-medium text-sm lg:text-base hover:bg-orange-200 hover:text-white transition'>
            Sign Up
          </button>
        </div>
        {/* nav mobile */}
