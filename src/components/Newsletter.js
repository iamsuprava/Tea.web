    ...
    <section className='section-sm lg:section-lg bg-green min-h-[520px] '>
      <div className='container mx-auto'>
        ...
        >
          ...
          <p
            className='text-orenge-200 mb-12'
            data-aos='fade-up'
            data-aos-delay='800'
            data-aos-offset='300'
          >
          ...
          >
            <div className='w-full relative flex'>
              <div className='absolute left-2 h-full w-12 flex justify-center items-center text-2xl text-orenge-300'>
                <MdEmail />
              </div>
              <input
                type='text'
                className='form-control w-full border border-white-300 bg-transparent outline-none placeholder:text-white-200 text-white pl-[60px]'
                placeholder='Enter your email address'
              />
            </div>
            <button className='btn btn-lg btn-green text-white w-full lg:max-w-[180px]'>
              Get started
            </button>
          </form>
        </div>
